...
parser.add_argument('--encoder-hidden', type=int, default=100,
                    help='Number of hidden units in encoder.')
parser.add_argument('--decoder-hidden', type=int, default=100,
...
parser.add_argument('--number-exp', type=int, default=10,
